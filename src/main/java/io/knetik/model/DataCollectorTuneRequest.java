...
public class DataCollectorTuneRequest {
   ...
   * @return campaignName
  **/
  @ApiModelProperty(example = "null", required = true, value = "Name of the campaign being tracked")
   ...
   * @return deviceId
  **/
  @ApiModelProperty(example = "null", required = true, value = "Unique ID of the device")
