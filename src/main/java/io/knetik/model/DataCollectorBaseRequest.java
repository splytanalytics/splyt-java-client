 ...
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-08-25T17:08:33.899-04:00")@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "request_type", visible = true )
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = DataCollectorUpdateUserStateRequest.class, name = "updateUserState"),
  @JsonSubTypes.Type(value = DataCollectorNewDeviceRequest.class, name = "newDevice"),
  @JsonSubTypes.Type(value = DataCollectorBeginTransactionRequest.class, name = "beginTransaction"),
  @JsonSubTypes.Type(value = DataCollectorTuneRequest.class, name = "tune"),
  @JsonSubTypes.Type(value = DataCollectorUpdateCollectionRequest.class, name = "updateCollection"),
  @JsonSubTypes.Type(value = NewEventRequest.class, name = "newEvent"),
  @JsonSubTypes.Type(value = DataCollectorUpdateTransactionRequest.class, name = "updateTransaction"),
  @JsonSubTypes.Type(value = DataCollectorEndTransactionRequest.class, name = "endTransaction"),
})
