...
public class DevicesApi {
    ...
    /* Build call for newDevice */
    private com.squareup.okhttp.Call newDeviceCall(String customerId, DataCollectorNewDeviceRequest request, Boolean checked, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call newDeviceValidateBeforeCall(String customerId, DataCollectorNewDeviceRequest request, Boolean checked, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling newDevice(Async)");
        }
        
        
        com.squareup.okhttp.Call call = newDeviceCall(customerId, request, checked, progressListener, progressRequestListener);
        return call;
    ...
    public void newDevice(String customerId, DataCollectorNewDeviceRequest request, Boolean checked) throws ApiException {
        newDeviceWithHttpInfo(customerId, request, checked);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> newDeviceWithHttpInfo(String customerId, DataCollectorNewDeviceRequest request, Boolean checked) throws ApiException {
        com.squareup.okhttp.Call call = newDeviceValidateBeforeCall(customerId, request, checked, null, null);
        return apiClient.execute(call);
    }

    /**
     * Submit a new device event (asynchronously)
     * Declares to the Knetik.io platform that a device is new at the given point in time. If the &#39;checked&#39; parameter is provided and set to &#39;true&#39;, however, the current state of the device in the Knetik.io platform is examined to determine if the device was previously declared as new and, if so, the device information is not updated in the Knetik.io platform.
     * @param customerId customerId (required)
     * @param request New device information (optional)
     * @param checked Flag indicating whether the device state should be checked before updating the state in the Knetik.io platform (optional, default to false)
     ...
     */
    public com.squareup.okhttp.Call newDeviceAsync(String customerId, DataCollectorNewDeviceRequest request, Boolean checked, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = newDeviceValidateBeforeCall(customerId, request, checked, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for updateDeviceState */
    private com.squareup.okhttp.Call updateDeviceStateCall(String id, String customerId, DataCollectorUpdateDeviceStateRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateDeviceStateValidateBeforeCall(String id, String customerId, DataCollectorUpdateDeviceStateRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateDeviceState(Async)");
        }
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling updateDeviceState(Async)");
        }
        
        
        com.squareup.okhttp.Call call = updateDeviceStateCall(id, customerId, request, progressListener, progressRequestListener);
        return call;
    ...
    public void updateDeviceState(String id, String customerId, DataCollectorUpdateDeviceStateRequest request) throws ApiException {
        updateDeviceStateWithHttpInfo(id, customerId, request);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateDeviceStateWithHttpInfo(String id, String customerId, DataCollectorUpdateDeviceStateRequest request) throws ApiException {
        com.squareup.okhttp.Call call = updateDeviceStateValidateBeforeCall(id, customerId, request, null, null);
        return apiClient.execute(call);
    }

    /**
     * Updates the state parameters for the given device (asynchronously)
     * 
     * @param id ID of the device for which state information is being updated (required)
     * @param customerId customerId (required)
     * @param request Updated device state information (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateDeviceStateAsync(String id, String customerId, DataCollectorUpdateDeviceStateRequest request, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateDeviceStateValidateBeforeCall(id, customerId, request, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
