...
public class UsersApi {
    ...
    /* Build call for newUser */
    private com.squareup.okhttp.Call newUserCall(String customerId, DataCollectorNewUserRequest request, Boolean checked, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call newUserValidateBeforeCall(String customerId, DataCollectorNewUserRequest request, Boolean checked, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling newUser(Async)");
        }
        
        
        com.squareup.okhttp.Call call = newUserCall(customerId, request, checked, progressListener, progressRequestListener);
        return call;
    ...
    public void newUser(String customerId, DataCollectorNewUserRequest request, Boolean checked) throws ApiException {
        newUserWithHttpInfo(customerId, request, checked);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> newUserWithHttpInfo(String customerId, DataCollectorNewUserRequest request, Boolean checked) throws ApiException {
        com.squareup.okhttp.Call call = newUserValidateBeforeCall(customerId, request, checked, null, null);
        return apiClient.execute(call);
    }

    /**
     * Submit a new user event (asynchronously)
     * Declares to the Knetik.io platform that the user is new at the given point in time. If the &#39;checked&#39; parameter is provided and set to &#39;true&#39;, however, the current state of the user in the Knetik.io platform is examined to determine if the user was previously declared as new and, if so, the user information is not updated in the Knetik.io platform.
     * @param customerId customerId (required)
     * @param request New user information (optional)
     * @param checked Flag indicating whether the user state should be checked before updating the state in the Knetik.io platform (optional, default to false)
     ...
     */
    public com.squareup.okhttp.Call newUserAsync(String customerId, DataCollectorNewUserRequest request, Boolean checked, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = newUserValidateBeforeCall(customerId, request, checked, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for updateUserState */
    private com.squareup.okhttp.Call updateUserStateCall(String id, String customerId, DataCollectorUpdateUserStateRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateUserStateValidateBeforeCall(String id, String customerId, DataCollectorUpdateUserStateRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateUserState(Async)");
        }
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling updateUserState(Async)");
        }
        
        
        com.squareup.okhttp.Call call = updateUserStateCall(id, customerId, request, progressListener, progressRequestListener);
        return call;
    ...
    public void updateUserState(String id, String customerId, DataCollectorUpdateUserStateRequest request) throws ApiException {
        updateUserStateWithHttpInfo(id, customerId, request);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateUserStateWithHttpInfo(String id, String customerId, DataCollectorUpdateUserStateRequest request) throws ApiException {
        com.squareup.okhttp.Call call = updateUserStateValidateBeforeCall(id, customerId, request, null, null);
        return apiClient.execute(call);
    }

    /**
     * Updates the entity state for the given user (asynchronously)
     * 
     * @param id ID of the user for whom state is being updated (required)
     * @param customerId customerId (required)
     * @param request Updated user state information (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateUserStateAsync(String id, String customerId, DataCollectorUpdateUserStateRequest request, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateUserStateValidateBeforeCall(id, customerId, request, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
