...
public class MobileApplicationTrackingApi {
    ...
    /* Build call for submitTuneRequest */
    private com.squareup.okhttp.Call submitTuneRequestCall(String customerId, DataCollectorTuneRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call submitTuneRequestValidateBeforeCall(String customerId, DataCollectorTuneRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling submitTuneRequest(Async)");
        }
        
        
        com.squareup.okhttp.Call call = submitTuneRequestCall(customerId, request, progressListener, progressRequestListener);
        return call;
    ...
    public void submitTuneRequest(String customerId, DataCollectorTuneRequest request) throws ApiException {
        submitTuneRequestWithHttpInfo(customerId, request);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> submitTuneRequestWithHttpInfo(String customerId, DataCollectorTuneRequest request) throws ApiException {
        com.squareup.okhttp.Call call = submitTuneRequestValidateBeforeCall(customerId, request, null, null);
        return apiClient.execute(call);
    }

    /**
     * Submit mobile application tracking data for Tune applications (asynchronously)
     * 
     * @param customerId customerId (required)
     * @param request Tune campaign tracking information (optional)
     ...
     */
    public com.squareup.okhttp.Call submitTuneRequestAsync(String customerId, DataCollectorTuneRequest request, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = submitTuneRequestValidateBeforeCall(customerId, request, progressListener, progressRequestListener);
