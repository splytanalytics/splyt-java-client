...
public class EventsApi {
    ...
    private com.squareup.okhttp.Call createEventCall(String customerId, NewEventRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createEventValidateBeforeCall(String customerId, NewEventRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling createEvent(Async)");
        }
        
        
        com.squareup.okhttp.Call call = createEventCall(customerId, request, progressListener, progressRequestListener);
        return call;
    ...
    public void createEvent(String customerId, NewEventRequest request) throws ApiException {
        createEventWithHttpInfo(customerId, request);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> createEventWithHttpInfo(String customerId, NewEventRequest request) throws ApiException {
        com.squareup.okhttp.Call call = createEventValidateBeforeCall(customerId, request, null, null);
        return apiClient.execute(call);
    }

    /**
     * Creates a single event (a transaction with no duration) (asynchronously)
     * 
     * @param customerId customerId (required)
     * @param request Similar to transactions, the details of that event (optional)
     ...
     */
    public com.squareup.okhttp.Call createEventAsync(String customerId, NewEventRequest request, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createEventValidateBeforeCall(customerId, request, progressListener, progressRequestListener);
