...
import io.knetik.client.auth.Authentication;
import io.knetik.client.auth.HttpBasicAuth;
import io.knetik.client.auth.ApiKeyAuth;
import io.knetik.client.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://api.knetik.io";
  ...
  public ApiClient() {
    ...
    setUserAgent("Swagger-Codegen/3.0.4/java");
