...
public class UsersApiTest {
     ...
     */
    @Test
    public void newUserTest() throws ApiException {
        String customerId = null;
        DataCollectorNewUserRequest request = null;
        Boolean checked = null;
        api.newUser(customerId, request, checked);
     ...
     */
    @Test
    public void updateUserStateTest() throws ApiException {
        String id = null;
        String customerId = null;
        DataCollectorUpdateUserStateRequest request = null;
        api.updateUserState(id, customerId, request);
