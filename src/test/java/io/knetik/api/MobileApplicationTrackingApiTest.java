...
public class MobileApplicationTrackingApiTest {
    ...
    private final MobileApplicationTrackingApi api = new MobileApplicationTrackingApi();
     ...
     */
    @Test
    public void submitTuneRequestTest() throws ApiException {
        String customerId = null;
        DataCollectorTuneRequest request = null;
        api.submitTuneRequest(customerId, request);
